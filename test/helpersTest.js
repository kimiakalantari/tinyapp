...
describe('emailDupeChecker', function() {
  
  it('should return true if email corresponds to a user in the database', function() {
    const existingEmail = emailDupeChecker("user1@example.com", testUsers);
  ...
  it('should return false if email does not correspond to a user in the database', function() {
    const nonExistantEmail = emailDupeChecker("fake_email@test.com", testUsers);
